...
var Element = {
    ...
    get style() {
        if (!this.__styles)
            this.__styles = new CSSStyleDeclaration(this.getAttribute('style')||'', this);
...
for (var name in attributes) {
    ...
    Object.defineProperty(Element, name, {
        enumerable: true,
        get: (function(name) {
            return function() { return this.getAttribute(name)||undefined; }
        })(name.toLowerCase()),
        set: (function(name) {
            return function(key) { this.setAttribute(name, key) }
        })(name.toLowerCase())
    })
}
